...
<<?=htmlentities($component->dynamicTag)?> <?=htmlentities($component->dynamicAttr)?>="<?=htmlentities($component->dynValue)?>"><?=htmlentities($component->content)?></<?=htmlentities($component->dynamicTag)?>>
