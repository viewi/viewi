...
class AppConfig
{
     ...
     * @param string[] $ignoreNamespace Do not process items for this namespace list (start with)
     * @param string[] $noJsNamespace Do not build JavaScript version for this namespace list (start with)
     * @return void 
     */
