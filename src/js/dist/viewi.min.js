...
`},function(e){return function(n){e.increment()}},function(e){return function(n){e.increment(n)}},function(e){return e.increment.bind(e)},function(e){return e.message}];var ne=class extends C{_name="HomePage";title="Viewi v2 - Build reactive front-end with PHP"},Te=[function(e){return e.title},function(e){return e.title}];var te=class extends C{_name="Layout";title="Viewi"},Ne=[function(e){return`
    ...
    `},function(e){return e.todo.items}];var se=class extends C{_name="ItemComponent"};var ae=class extends C{_name="SomeComponent"};var le=class extends C{_name="TestButton";id=null;title=null;class=null},_e=[function(e){return e.id},function(e){return e.title},function(e){return e.class},function(e){return" "+(e.title??"")+`
`}];function be(e){var n=typeof window<"u"?window:global;n.$locutus=n.$locutus||{};var t=n.$locutus;t.php=t.php||{};var o=n.JSON,i;try{if(typeof o=="object"&&typeof o.stringify=="function"){if(i=o.stringify(e),i===void 0)throw new SyntaxError("json_encode");return i}var c=e,u=function(a){var b=["\0-","\x7F-\x9F","\xAD","\u0600-\u0604","\u070F","\u17B4","\u17B5","\u200C-\u200F","\u2028-\u202F","\u2060-\u206F","\uFEFF","\uFFF0-\uFFFF"].join(""),r=new RegExp('[\\"'+b+"]","g"),f={"\b":"\\b","	":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"};return r.lastIndex=0,r.test(a)?'"'+a.replace(r,function(x){var y=f[x];return typeof y=="string"?y:"\\u"+("0000"+x.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'},s=function(a,b){var r="",f="    ",x=0,y="",v="",l=0,T=r,p=[],m=b[a];switch(m&&typeof m=="object"&&typeof m.toJSON=="function"&&(m=m.toJSON(a)),typeof m){case"string":return u(m);case"number":return isFinite(m)?String(m):"null";case"boolean":return String(m);case"object":if(!m)return"null";if(r+=f,p=[],Object.prototype.toString.apply(m)==="[object Array]"){for(l=m.length,x=0;x<l;x+=1)p[x]=s(x,m)||"null";return v=p.length===0?"[]":r?`[
`+r+p.join(`,
`+r)+`
`+T+"]":"["+p.join(",")+"]",v}for(y in m)Object.hasOwnProperty.call(m,y)&&(v=s(y,m),v&&p.push(u(y)+(r?": ":":")+v));return v=p.length===0?"{}":r?`{
`+r+p.join(`,
`+r)+`
`+T+"}":"{"+p.join(",")+"}",v;case"undefined":case"function":default:throw new SyntaxError("json_encode")}};return s("",{"":c})}catch(a){if(!(a instanceof SyntaxError))throw new Error("Unexpected error type in json_encode()");return t.php.last_error_json=4,null}}var me=class extends C{_name="TestComponent";name="MyName";name2="";_name2_Test="MyName_2";empty="";null=null;url="/home";attr="title";event="(click)";arr=["a","b","c"];arrWithKeys={a:"Apple",b:"Orange",c:"Lemon"};arrNested={a:{a:"Apple",b:"Orange",c:"Lemon"},b:{a:"Apple",b:"Orange",c:"Lemon"},c:{a:"Apple",b:"Orange",c:"Lemon"}};ifValue=!0;ifElseValue=!0;nestedIf=!0;dynamic="div";dynamic2="ItemComponent";raw="<b><i>Raw html text</i></b>";isDisabled=!0;message="Some message";checked=!1;checked2=!0;checkedNames=[];picked="One";selected="";selectedList=["A","C"];getNames(){return be(this.checkedNames)}getName(n){var t=60;return n??"DefaultName"}addTodo(){this.arrNested={a:{a:"Apple",b:"Orange",c:"Lemon"},d:{R:"Rat",T:"Dog",G:"Cat"},b:{a:"Apple",b:"Orange",c:"Lemon"}}}onEvent(n){n.preventDefault()}toggleIf(){this.ifValue=!this.ifValue,this.arr=this.ifValue?["a","b","c"]:["x","b","r"]}toggleElseIf(){this.ifElseValue=!this.ifElseValue}},Se=[function(e){return"Tag test "+(e.name??"")+" "+(e.name2??"")+" "+(e._name2_Test??"")},function(e){return`
